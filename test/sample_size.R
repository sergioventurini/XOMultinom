...
# power_optim(nval = 100, k = 10, delta = 0.2, power = 0.8, alpha = 0.05,
#             type = "min", method_f = "Corrado", verbose = TRUE)
# power_optimize(k = 5, n_max = 2000, delta = 0.2, power = 0.8, alpha = 0.05,
#                type = "min", method_f = "Corrado", verbose = TRUE)
