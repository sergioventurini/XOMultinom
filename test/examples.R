source("./utils.R")
source("./pmaxmultinom.R")
source("./dmaxmultinom.R")
source("./pminmultinom.R")
source("./dminmultinom.R")
...
par(mfrow = c(2, 1), mar = c(4, 4, 1, 1) + 0.1)
plot(xseq[xidx], pmfmax_emp, pch = 20, , type = "h", xlab = "x", ylab = "PMF of max")
...
par(mfrow = c(2, 1), mar = c(4, 4, 1, 1) + 0.1)
plot(xseq[xidx], pmfmin_emp, pch = 20, , type = "h", xlab = "x", ylab = "PMF of min")
