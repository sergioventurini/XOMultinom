...
#'
#' Draws independent random samples from the exact distribution of the maximum
...
#'   the distribution of \eqn{\max(N_1, \ldots, N_m)}.
#'
#' @details
#'   The exact PMF over the support \eqn{\{0, 1, \ldots, \mathtt{size}\}} is
#'   computed once using \code{\link{dmaxmultinom}}, and \code{n} independent
...
#' \code{\link{qmaxmultinom}} for quantiles.
#'
#' @export
